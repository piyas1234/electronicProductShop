...
const STRIPE_PK = 'pk_test_51J4czTL4qT5dhMtCLvHyodfJMhlJz1rb6lD5ExPaD9wTmr7jKB8fDvL8pK9wQOnrkz97ZJRcBoHyBPdcZRCAvkpy00Haw2Aobl'


const Payment = (props) => { 

    const { amount, product ,setPatyment, setCart ,setMsg} = props
    ...
    const htmlContent = `
            ...
            <body>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <h1 class="products-info   text-white">
                            Amount: ${amount}
                        </h1>
                    </div>
                    <div class="row">
